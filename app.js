...
console.log('serving homepage')
        ...
        fs.readFile(__dirname + '/bits/amp.pug', function (error, source) {
            ...
            var data = {
                ...
                img: '/img.png',
                stores: [],
                promos: [[id: 257, discount: null, promoName: "Test", promoBanner: "/bitsAssets/tmp/promotions/55JLVp34WnKXO86Cu8t8yZcDiLQ8y7U2NLKRaeJg0DhDOZUZfnAnE67DPuMN.png", promoOwner: 12], [id: 257, discount: null, promoName: "Test", promoBanner: "/bitsAssets/tmp/promotions/55JLVp34WnKXO86Cu8t8yZcDiLQ8y7U2NLKRaeJg0DhDOZUZfnAnE67DPuMN.png", promoOwner: 12]], managers: [],
                cid: '000'
            }
            data.body = process.argv[2];
            //jade.render
